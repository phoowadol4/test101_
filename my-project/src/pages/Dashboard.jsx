...
export default function Dashboard() {
  ...
  const menuItems = [
    { icon: '🏠', label: 'หน้าแรก', path: '/dashboard' },
    { icon: '📊', label: 'สถิติ', path: '/dashboard/stats' },
    { icon: '👥', label: 'ผู้ใช้งาน', path: '/dashboard/users' },
    { icon: '⚙️', label: 'ตั้งค่า', path: '/dashboard/settings' },
    { icon: '📋', label: 'รายงาน', path: '/dashboard/reports' },
    { icon: '🔔', label: 'แจ้งเตือน', path: '/dashboard/notifications' },
  ];
